...
### Largely inspired by https://github.com/RoverWire/virtualhost. All credits go to RoverWire :)
...
sitesEnabled='/usr/local/etc/httpd/extra/vhost/sites-enabled/'
sitesAvailable='/usr/local/etc/httpd/extra/vhost/sites-available/'
userDir='/Users/spyesx/www/'
...
if [ "$action" == 'create' ]
	then
		...
		<VirtualHost *:80>
			...
			ErrorLog /usr/local/var/log/httpd/$domain_error.log
			LogLevel error
			CustomLog /usr/local/var/log/httpd/$domain_access.log combined
